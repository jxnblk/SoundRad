...
// For drag and drop repeats

var HashQueueMap, cuMoveCursorToEnd, dragndropdemo, hashKey, isArray, module, nextUid, uid;

soundrad.directive('cuReorderHandle', function() {
  return {
    transclude: false,
    priority: 999,
    terminal: false,
...
soundrad.directive('cuRepeatReorder', function() {
  return {
    transclude: "element",
    priority: 1000,
    terminal: true,
...
////////
// Something for the draggable list stuff
